...
public class PrintMetrics extends HttpServlet {
    ...
    private void initializePlots(boolean init) {
        if (init) {
            ...
            create = true;
            if (properties != null && properties.getPlots().containsKey("plot6") && properties.getFrames().get("plot6") != null) {
                create = false;
            }
            ...
            if (create) {
                ...
                frame6.addWindowListener(new java.awt.event.WindowAdapter() {
                    public void windowClosed(java.awt.event.WindowEvent evt) {
                        ...
                        DeploymentMetricProperties.getDeploymentMetricProperties().getDeploymentMetricProperty(groupName).getPlots().remove("plot6");
                    }
                });
