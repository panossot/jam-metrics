...
public class PrintMetrics extends HttpServlet {
     ...
     */
    @EJB
    private MemoryMetricsBean memoryMetricsBean;
    
    private String groupName = "memoryMetrics";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>JVM Heap utilization statistics [MB]: </h1>");
            memoryMetricsBean.memoryMetrics();
