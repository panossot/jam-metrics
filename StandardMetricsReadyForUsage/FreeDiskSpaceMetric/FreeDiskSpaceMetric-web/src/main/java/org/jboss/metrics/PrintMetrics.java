...
public class PrintMetrics extends HttpServlet {
     ...
     */
    @EJB
    private FreeDiskSpaceMetricBean freeDiskSpaceMetricBean;
    
    private String groupName = "freeDiskSpace";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>FreeDiskSpace-Metric</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>FreeDiskSpace-Metric of Root of a Linux OS (GB): </h1>");
            freeDiskSpaceMetricBean.freeDiskSpace();
