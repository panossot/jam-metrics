...
public class MetricsApiSeTestClass {
    ...
    public void countMethod() throws IllegalArgumentException, IllegalAccessException {
        ...
        JMathPlotAdapter.jMathPlotAdapter(count2, "myTestGroup", properties, "plot2", "count2", "red", "bar", false);
        JMathPlotAdapter.jMathPlotAdapter(count, "myTestGroup", properties, "plot3", "count", "red", "scatter", false);
        ...
        JMathPlotAdapter.jMathPlotAdapter(count, "myTestGroup", properties, "plot4", "count", "green", "stair", false);
