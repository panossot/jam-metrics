...
public class MetricsApiSeTestClass {
    ...
    public MetricsApiSeTestClass() {
        ...
        count = new Metric("count11", 0, metricProperties);
        count2 = new Metric("count12", 0, metricProperties);
    }
    ...
    public void countMethod() throws Exception {
        ...
        for (int j=0; j<100; j++) {
            count.applyMetricFeatures(applyMetricFeatures1,"MetricsApiSeTestClass.countMethod");
            count2.applyMetricFeatures(applyMetricFeatures2,"MetricsApiSeTestClass.countMethod");
        }
    }
