...
public class MetricsApiSeTestClass {
    ...
    public void countMethod() throws IllegalArgumentException, IllegalAccessException {
        ...
        JMathPlotAdapter.jMathPlotAdapter(count2, "myTestGroup", properties, "plot3", "count2", "red", "scatter", false);
        JMathPlotAdapter.jMathPlotAdapter(count, "myTestGroup", properties, "plot6", "count", "green", "scatter", false);
        JMathPlotAdapter.jMathPlotAdapter(count, "myTestGroup", properties, "plot3", "count", "cyan", "line", false);
        JMathPlotAdapter.jMathPlotAdapter(count2, "myTestGroup", properties, "plot6", "count2", "magenta", "line", false);
    }
