...
public class MetricsApiSeTestClass {
    ...
    public void countMethod() throws IllegalArgumentException, IllegalAccessException {
        ...
        JMathPlotAdapter.jMathPlotAdapter(count2, "myTestGroup", properties, "plot2", "count2", "blue", "scatter", true);
        JMathPlotAdapter.jMathPlotAdapter(count, "myTestGroup", properties, "plot5", "count", "green", "scatter", true);
        JMathPlotAdapter.jMathPlotAdapter(count, "myTestGroup", properties, "plot2", "count", "magenta", "line", true);
        JMathPlotAdapter.jMathPlotAdapter(count2, "myTestGroup", properties, "plot5", "count2", "blue", "line", true);
    }
}
